...
- (void)viewDidLoad {
    ...
    // self means "this current class", like "this" in other languages
    // the dot lets you access the properties on the class
    // to create and array - @[item1, item2, item3]
    // each item in this array is a string. You need to prefix them with the @ symbol
    self.myQuotes = @[
                        @"Live and let live",
